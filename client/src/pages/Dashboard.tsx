...
export default function Dashboard() {
  ...
  const translations = {
    ...
    pageDescription: "Vue d'ensemble de votre validation et gestion de base de données",
    refresh: "Actualiser",
    quickUpload: "Téléchargement Rapide",
    invoicesPerDay: "Factures par Jour",
    lastThirtyDaysAverage: "Moyenne des 30 derniers jours",
    averageInvoiceValue: "Valeur Moyenne des Factures",
    comparedToLastMonth: "Comparé au mois dernier",
    averageDailyTotal: "Total Quotidien Moyen",
    sevenDayRollingAverage: "Moyenne mobile sur 7 jours",
    recentValidationRuns: "Exécutions de Validation Récentes",
    viewAll: "Voir Tout",
    noValidationRuns: "Aucune exécution de validation pour le moment",
    ...
    validationAnalytics: "Analyses de Validation",
    viewFullAnalytics: "Voir les Analyses Complètes",
    analyticsChart: "Le graphique d'analyses s'afficherait ici",
    dailyValidationTrends: "Tendances de validation quotidiennes",
    successRate: "Taux de Réussite",
    rowsProcessed: "Lignes Traitées",
    activeRules: "Règles Actives",
    databaseSummary: "Résumé de la Base de Données",
    codes: "Codes",
    viewAndManageCodes: "Voir et gérer les codes",
    establishments: "Établissements",
    viewAndManageEstablishments: "Voir et gérer les établissements",
    contexts: "Contextes",
    viewAndManageContexts: "Voir et gérer les contextes",
    rules: "Règles",
    viewAndManageRules: "Voir et gérer les règles",
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card data-testid="card-invoices-per-day">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">{translations.invoicesPerDay}</p>
              <div className="mt-4 text-xs text-muted-foreground">
                {translations.lastThirtyDaysAverage}
              </div>
            </CardContent>
          </Card>
          ...
          <Card data-testid="card-avg-invoice-value">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">{translations.averageInvoiceValue}</p>
              <div className="mt-4 text-xs text-muted-foreground">
                {translations.comparedToLastMonth}
              </div>
            </CardContent>
          </Card>
          ...
          <Card data-testid="card-avg-daily-total">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">{translations.averageDailyTotal}</p>
              <div className="mt-4 text-xs text-muted-foreground">
                {translations.sevenDayRollingAverage}
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle>{translations.recentValidationRuns}</CardTitle>
              ...
              <CardContent>
                {runsLoading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-4">{translations.uploadFirstFile}</p>
                    <Link href="/validator/upload">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{translations.systemStatus}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">{translations.database}</span>
                  <Badge className="bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-200">
                    {translations.healthy}
                  </Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">{translations.validationEngine}</span>
                  <Badge className="bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-200">
                    {translations.running}
                  </Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">{translations.storage}</span>
                  <Badge variant="outline">
                    78{translations.percentUsed}
                  </Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{translations.recentExports}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{translations.hoursAgo}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-muted/50 rounded-lg">
                  <FileDown className="w-4 h-4 text-muted-foreground" />
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{translations.dayAgo}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <CardContent>
              ...
              <div className="h-48 bg-muted/30 rounded-xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">{translations.analyticsChart}</p>
                  <p className="text-sm text-muted-foreground">{translations.dailyValidationTrends}</p>
                </div>
              </div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{translations.successRate}</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-foreground">1.2M</p>
                  <p className="text-sm text-muted-foreground">{translations.rowsProcessed}</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-foreground">23</p>
                  <p className="text-sm text-muted-foreground">{translations.activeRules}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{translations.databaseSummary}</CardTitle>
            </CardHeader>
              ...
              <Link href="/database/codes">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl hover:bg-muted transition-colors cursor-pointer" data-testid="card-database-codes">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">{translations.codes}</p>
                      <p className="text-sm text-muted-foreground">{translations.viewAndManageCodes}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-foreground">+124</p>
                    <p className="text-xs text-muted-foreground">{translations.thisWeek}</p>
                  </div>
                </div>
              </Link>
              ...
              <Link href="/database/establishments">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl hover:bg-muted transition-colors cursor-pointer" data-testid="card-database-establishments">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">{translations.establishments}</p>
                      <p className="text-sm text-muted-foreground">{translations.viewAndManageEstablishments}</p>
                    </div>
                  </div>
                  <div className="text-right">
              ...
              <Link href="/database/contexts">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl hover:bg-muted transition-colors cursor-pointer" data-testid="card-database-contexts">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">{translations.contexts}</p>
                      <p className="text-sm text-muted-foreground">{translations.viewAndManageContexts}</p>
                    </div>
                  </div>
                  <div className="text-right">
              ...
              <Link href="/database/rules">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl hover:bg-muted transition-colors cursor-pointer" data-testid="card-database-rules">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">{translations.rules}</p>
                      <p className="text-sm text-muted-foreground">{translations.viewAndManageRules}</p>
                    </div>
                  </div>
                  <div className="text-right">
